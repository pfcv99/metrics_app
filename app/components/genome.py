...
def assembly(assembly, analysis):
    paths = {
        "GRCh38/hg38": {
            ...
            "Gene Panel": 'data/regions/genome_exons/hg38_Twist_ILMN_Exome_2.0_Plus_Panel_annotated_modif_nochr.bed',
        ...
        "GRCh37/hg19": {
            ...
            "Gene Panel": 'data/regions/genome_exons/hg19_Twist_ILMN_Exome_2.0_Plus_Panel_annotated_modif_nochr.BED',
